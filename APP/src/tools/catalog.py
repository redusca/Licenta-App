...
TOOLS: list[dict] = [
...

    {
        ...
        "usageSteps": [
            "Click \"Run Tool\" to open the Image Converter panel.",
            "Drag and drop or browse to select one or more input images.",
            "Choose the desired output format from the dropdown.",
            "Adjust quality if needed, then click Convert.",
            "Download the converted files from the output section.",
        ],
